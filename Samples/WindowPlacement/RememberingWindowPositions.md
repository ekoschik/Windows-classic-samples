...
This README is paired with the header files in the cpp\inc directory.

- [PlacementEx.h](cpp\inc\PlacementEx.h)
- [MiscUser32.h](cpp\inc\MiscUser32.h)
- [MonitorData.h](cpp\inc\MonitorData.h)
- [CurrentMonitorTopology.h](cpp\incCurrentMonitorTopology.h)
...
This README, and [PlacementEx.h](cpp\inc\PlacementEx.h), introduce fresh guidance for
...
See `PlacementEx::FindClosestMonitor` in [PlacementEx.h](cpp\inc\PlacementEx.h), and
`MonitorData::FromDeviceName` in [MonitorData.h](cpp\inc\MonitorData.h) for an
...
See [VirtualDesktopIds.h](cpp\inc\VirtualDesktopIds.h) for examples and more information
...
See `PlacementParams`, defined in [PlacementEx.h](cpp\inc\PlacementEx.h), which
...
See `PlacementEx::AdjustForMainWindow` in [PlacementEx.h](cpp\inc\PlacementEx.h) where
...
See `PlacementEx::SetLogicalSize` in [PlacementEx.h](cpp\inc\PlacementEx.h), which
...
1. Pick a final monitor and adjust the position as needed.
  ...
  these steps in [PlacementEx.h](cpp\inc\PlacementEx.h).
...
2. Cloak the window
  ...
  - See TempCloakWindowIf in [MiscUser32.h](cpp\inc\MiscUser32.h), which calls
